...
//        System.out.println("tn.esprit.gestionzoo.entities.Zoo avec le plus d'animaux : " + plusGrand);
    ...
    //    Dolphin dph = new Dolphin();
    //    Penguin pg = new Penguin();

        Aquatic aq = new Aquatic("Fish","q",6,false,"mer");
        Terrestrial tr = new Terrestrial("Felidae", "Lion", 3, true, 4);
        Dolphin dph = new Dolphin("delph","del",2,true,"ocean", 5);
        Penguin pg = new Penguin("peng","pen",4, false,"ice", 10);
